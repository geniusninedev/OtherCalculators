...
public class unitConversion  extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener{
    ...
    private static unitConversion instance;
            ...
            if (queryString != null)
            {
                ...
                for (final String tempParameterString : arrParameters)
                {
                    ...
                    if (arrTempParameter.length >= 2)
                    {
                        ...
                        Toast.makeText(this, parameterValue,Toast.LENGTH_SHORT).show();
                    }
                }
            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            Intent intent=new Intent(unitConversion.this,MainActivity.class);
            finish();
